...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    emailHighlights: [
      ...
      "**Invoices for freelancers and sole traders.** Track who owes you, when invoices were sent, and what's been paid. Simple list that exports cleanly to your accountant. Cash basis (the default since April 2024) means Tax Readiness only counts income that's actually arrived.",
    ...
    items: [
      ...
      "**Invoices.** Sole traders and freelancers can now track outstanding work in MileClear. Each invoice carries a company name, amount, sent date, due date (30 days by default), and paid status. Simple list that exports cleanly to your accountant.",
