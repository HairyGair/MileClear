...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      "Park and walk away, and the drive ends two minutes later. It used to stay open until the phone stopped moving, so a round of golf or a long shop kept the lock-screen counter running for hours",
      "A walk no longer starts a recording in the first place: a walking-pace movement, or a single jumpy GPS reading while you are on foot, is not taken as the start of a drive",
      "Runs and walks your phone's sensors confirmed are no longer offered back to you as journeys to check",
      "A drive that averaged driving speed is never thrown away as a walk, even when the phone thought it was in your pocket",
      "A drive at clear driving speed starts recording even when the GPS signal is weak",
      "Pause recording until 6am tomorrow or for a week, and it switches itself back on when the pause ends, without you opening the app",
      "Journeys to check and \"Missing a trip you made?\" sit at the top of Trips, where you can reach them",
      "Save a place from where you are or from any trip's address, pick any saved place for a trip rather than the first six, and Add Location sits at the top of Saved Locations",
      "Start a new trip from any trip's address, and pick a place you have been before when you add one",
      "Fix a trip's times: move a recorded trip's start earlier or its end pin further on to add the stretch the phone missed, and correct the start time of a trip you typed in",
      "A trip you stop on the Arrive screen is kept, even if you leave the screen before saving",
      "A queue of traffic no longer splits a drive in two, and a split names the stop it cut at",
  ...
  },
  {
    ...
    items: [
      ...
      "The trip list opens in a fraction of a second: the slowest screen in the app was doing needless work on every page and now does none of it",
      "Drives between places you have already sorted the same way are classified for you, marked as such, with a one-tap undo for a week; the app asks about the rest once a week instead of every day",
      "After your tenth trip the app offers, once, to save your two most-visited places by name, and the saved-places card no longer vanishes after your first save",
      "The lock-screen Live Activity no longer disappears part-way through a drive; the app was closing its own activity each time it tried to start another",
    ],
    ctaUrl: "https://mileclear.com/releases",
    ctaLabel: "Read the release notes",
    ...
    emailHighlights: [
      ...
      "**Routine drives sort themselves** - marked as automatic, with an undo, and the app asks about the rest weekly rather than daily.",
      "**The Live Activity stays up** - the lock-screen counter no longer vanishes mid-drive.",
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      "**Making Tax Digital groundwork continues.** The app now reports the exact device details HMRC's fraud-prevention rules require. That is part of the work still to be completed before Making Tax Digital submissions can reach HMRC for real - the feature stays in beta against HMRC's test service until then.",
  ...
  },
  {
    ...
    items: [
      ...
      "**Add a note to any trip.** Jot a quick reminder of what a journey was for, right on the trip card - handy come tax time. The back button across trip screens is more reliable too.",
      "**A clear heads-up when auto-tracking is off.** If automatic detection gets switched off, the dashboard now says so plainly and asks you to confirm before disabling it, so you are never silently not recording.",
      "**Fewer surprise sign-outs.** Tightened how your login refreshes in the background so the app stops occasionally bumping you to the sign-in screen.",
      "**Invite codes now reach sign-up.** When you share MileClear, your invite code carries through to the new driver's sign-up, so your free-month referral actually lands.",
    ],
  },
  {
    version: "1.3.3",
  ...
  },
  {
    ...
    items: [
      ...
      "**A captured drive can no longer be thrown away at the last step.** In one rare path, a trip recorded perfectly at the native level could be judged on a starved handful of GPS points after a long phone-asleep stretch — and discarded as 'not a real drive'. Every save path now reads the full native recording before judging, so a drive ClearTrack captured is a drive you keep. Thanks to the driver whose one-tap report led us straight to it.",
  ...
  },
  {
    ...
    emailTagline:
      "Two weeks after 1.2.0, the next layer of the Money Picture stack is here. Snap a receipt and the amount, date, and vendor fill themselves in. Connect your bank and every transaction lands in a triage inbox — accept it as an earning or an expense in one tap. The more you triage, the smarter the suggestions get. Every business cost in one place, ready for your tax return.",
    emailHighlights: [
      "**HMRC AMAP rate updated to 55p.** From the 2026-27 tax year (trips from 6 April 2026 onwards), HMRC raised the per-mile rate for cars and vans to 55p for the first 10,000 business miles (up from 45p). 25p above 10,000 and 24p flat for motorbikes are unchanged. Every total in MileClear now uses the correct rate per trip date — 45p for older trips, 55p for trips from 6 April 2026.",
    ...
    items: [
      "**HMRC AMAP rate updated to 55p for 2026-27 onwards.** From 6 April 2026, cars and vans use 55p per mile for the first 10,000 business miles (up from 45p), then 25p above 10,000. Motorbikes stay at 24p flat. MileClear now picks the right rate per trip based on its date — old trips stay at 45p, new trips use 55p. All historical Self Assessment summaries are unchanged.",
  ...
  },
  {
    ...
    emailHighlights: [
      "**Quarterly Self Assessment updates (beta).** Connect your HMRC account, confirm your trade, preview each quarterly update against your MileClear figures, and submit. The headline figures cross-check against HMRC's own calculation engine so you see the marginal-rate breakdown before it's locked in. The headline tax feature most UK sole traders will need from April 2026 - already in the app.",
  ...
  },
  {
    ...
    items: [
      ...
      "Attestation cover sheet on the Self Assessment PDF - one-page signed declaration page sits in front of the existing report, with your name, UTR (blank for you to fill in), tax year period, and contemporaneous-record attestation language. Pro feature.",
...
export const ANDROID_RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      "The trips list reads down through each day, in the order you drove",
      "A drive at clear driving speed starts recording even when the GPS signal is weak, which was stopping some Android phones recording at all",
      "A pause now ends when it says it will, without you opening the app",
      "Journeys to check and \"Missing a trip you made?\" sit at the top of Trips, where you can reach them",
      "Pick any saved place for a trip, not just the first six, and Add Location sits at the top of Saved Locations",
      "A drive that averaged driving speed is never thrown away as a walk",
      "The Self Assessment PDF shows the tax year starting on 6 April, platforms by name, and prices your business miles at HMRC's rates throughout",
    ],
  },
  {
