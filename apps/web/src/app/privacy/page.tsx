            ...
            <section id="how-used" className="legal__section">
              ...
              <div className="legal__card">
                ...
                <ul className="legal__list">
                  ...
                  <li className="legal__list-item">Calculating tax deductions at HMRC's approved mileage rates (55p/mile for cars up to 10,000 miles, 25p/mile thereafter; 24p/mile for motorbikes - the first-tier rate rose from 45p to 55p on 6 April 2026)</li>
