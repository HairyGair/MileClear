...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    items: [
      ...
      "Empty-state dashboard rework - new users finishing onboarding used to land on a sea of zeros: £0 saved, 0 trips, empty heatmap, empty benchmark, empty calendar. The hero now shows a Day 1 welcome with 'Tap Start Trip the next time you drive. Your HMRC deduction starts adding up from your first business mile.' Cards that need real data to be useful (Tax Readiness, Weekly Goal, Activity Heatmap, How You Compare, Working Calendar) are hidden until you've logged enough trips to make them meaningful (5 for the analytics cards, 1 for the rest). They appear automatically as you accumulate data.",
      "Bluetooth detection scaffolding removed - the 'connect car Bluetooth and trips start automatically' promise was never deliverable on iOS, which forbids third-party apps from detecting Bluetooth Classic device connections (which is what cars use, not BLE). All BT references stripped from the dashboard, vehicle form, sync flow, detection task and onboarding. CarPlay activation events are the realistic future path for 'user is in their car' detection, and that's tracked separately.",
