  ...
  return (
    <section id="early-access" className="section ea">
      <div className="container ea__wrap">
        ...
        <p className="subtext">
          Download MileClear for free and start recording every trip straight away.
          No credit card, no trial period, no trip limits.
        </p>
          ...
          <div className="ea__notify">
            ...
            {status === "ok" ? (
              <div className="ea__ok">
                You&apos;re on the list. We&apos;ll email you as soon as MileClear is available on Android.
              </div>
            ) : (
