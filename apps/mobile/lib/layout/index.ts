...
export const SECTION_REGISTRY: Record<ScreenKey, SectionDef[]> = {
  ...
  avatar_menu: [
    ...
    { key: "menu_reconciliation", label: "HMRC Reconciliation", icon: "git-compare-outline" },
    { key: "menu_exports", label: "Tax Exports", icon: "download-outline" },
    { key: "menu_accountant", label: "My Accountant", icon: "people-outline" },
    { key: "menu_work_tax", label: "Work & Tax Settings", icon: "briefcase-outline" },
    ...
    { key: "menu_bank", label: "Connect Bank", icon: "business-outline" },
    { key: "menu_inbox", label: "Bank Inbox", icon: "mail-unread-outline" },
    { key: "menu_insights", label: "Business Insights", icon: "stats-chart-outline" },
